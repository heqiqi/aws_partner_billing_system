...
class Dept(CoreModel):
    ...
    access_key = models.CharField(max_length=256, verbose_name="AK", null=True, blank=True, help_text="AK")
    secret_key = models.CharField(max_length=256, verbose_name="SK", null=True, blank=True, help_text="SK")
    dashboard_url = models.CharField(max_length=512, verbose_name="DASHBOARD", null=True, blank=True, help_text="DASHBOARD")
    account_id = models.IntegerField(default=0, verbose_name="账号ID", null=True, blank=True, help_text="账号ID")
