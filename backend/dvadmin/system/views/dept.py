...
class DeptSerializer(CustomModelSerializer):
    ...
    def get_secret_key(self, obj: Dept):
        return obj.secret_key[0:4]+'******************************'
...
class DeptCreateUpdateSerializer(CustomModelSerializer):
    ...
    def update(self, instance, validated_data):
        print("update validated_data: {}, instance: {} ".format(validated_data, instance))
        if "*****" in validated_data['secret_key']:
            print("***** in")
