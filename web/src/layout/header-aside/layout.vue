    ...
    <div class="d2-layout-header-aside-content" flex="dir:top">
      ...
      >
        ...
        <div class="d2-header-right" flex-box="0">
          ...
          <d2-header-search @click="handleSearchClick"  v-if="$env === 'development2'"/>
          <d2-header-log  v-if="$env === 'development2'"/>
          <d2-header-fullscreen  v-if="$env === 'development2'"/>
          <d2-header-theme v-if="$env === 'development2'" />
          <d2-header-message  v-if="$env === 'development2'"/>
          <d2-header-size  v-if="$env === 'development2'"/>
          <d2-header-locales  v-if="$env === 'development2'"/>
          <d2-header-color  v-if="$env === 'development2'"/>
          <d2-header-user />
        </div>
      </div>
      <!-- 下面 主体 -->
